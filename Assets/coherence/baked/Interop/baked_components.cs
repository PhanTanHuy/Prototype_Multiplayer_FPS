...
namespace Coherence.Generated
{
    ...
    using Coherence.Toolkit;
        ...
        public struct _8bcb38f142e01ba4db9b68bf249cb184_8902942521136083295 : ICoherenceComponentData
        {
            public void ResetFrame(AbsoluteSimulationFrame frame)
            {
                FieldsMask |= _8bcb38f142e01ba4db9b68bf249cb184_8902942521136083295.WalkValueMask;
                WalkValueSimulationFrame = frame;
            }
    
            public static uint WalkValueMask => 0b00000000000000000000000000000001;
            public AbsoluteSimulationFrame WalkValueSimulationFrame;
            public System.Single WalkValue;
            ...
            public ICoherenceComponentData MergeWith(ICoherenceComponentData data)
            {
                var other = (_8bcb38f142e01ba4db9b68bf249cb184_8902942521136083295)data;
                var otherMask = other.FieldsMask;
                ...
                if ((otherMask & 0x01) != 0)
                {
                    this.WalkValueSimulationFrame = other.WalkValueSimulationFrame;
                    this.WalkValue = other.WalkValue;
                }
            ...
            public static uint Serialize(_8bcb38f142e01ba4db9b68bf249cb184_8902942521136083295 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
            {
                if (bitStream.WriteMask(data.StoppedMask != 0))
                {
                    bitStream.WriteMaskBits(data.StoppedMask, 1);
            ...
            public static _8bcb38f142e01ba4db9b68bf249cb184_8902942521136083295 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
            {
                var stoppedMask = (uint)0;
                if (bitStream.ReadMask())
                {
                ...
                var val = new _8bcb38f142e01ba4db9b68bf249cb184_8902942521136083295();
                if (bitStream.ReadMask())
                {
    
                    val.WalkValue = bitStream.ReadFloat(FloatMeta.NoCompression());
                    val.FieldsMask |= _8bcb38f142e01ba4db9b68bf249cb184_8902942521136083295.WalkValueMask;
                }
